...
\begin{enumerate}
	...
	\item 通过光电效应（Photoelectric effect），光阴极内的电子被激发并逃逸到真空中。这些逃逸的电子被称为光电子（Photoelectron）；光电转换的效率被称为量子效率($\eta$)，它是光电子数与入射光子的比值。
	\item 在聚焦电极的加速、引导下，大部分光电子被聚焦，并击中第一打拿极。聚焦极和光阴极形成的电场能够控制电子的轨迹，因此它们被称为电子光学系统。
	\item 打拿极材料一般使用二次电子发射系数（$\delta\gg1$）较高的材料，这样一个原初电子轰击其表面就能产生$\delta$个次级电子。这些次级电子在极间电压的作用下，再次被加速并轰击下一个打拿极，从而产生更多的次级电子。多个打拿极串联在一起，使得电子逐级倍增，打拿极间的电流不断变大，这就是PMT的倍增过程。因此，打拿极系统也被称为PMT的电子倍增器。
	\item 最后一个打拿极产生的次级电子最终被阳极收集并引出，这样PMT就把微弱的光信号转换成了可处理的电流信号。
\end{enumerate}
