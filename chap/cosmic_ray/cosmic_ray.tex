...
\subfloat[][能量响应一致性]{
	...
	\includegraphics[width=0.48\textwidth]{chap/cosmic_ray/fig/consist_dist.png}
}
\subfloat[][MIP能量分辨率]{
	\label{fig:cosmic_ray:energy_res_dist}
	\includegraphics[width=0.48\textwidth]{chap/cosmic_ray/fig/energy_res_dist.png}
}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\textwidth]{chap/cosmic_ray/fig/atten_dist.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.65\textwidth]{chap/cosmic_ray/fig/dy58_dist.png}
