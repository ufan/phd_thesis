...
根据拟合结果，我们计算了每个探测单元模块最远端和最近端相对于中间位置的光输出强度比值，结果如图\ref{fig:cosmic_ray:atten_dist}所示。可以看到，所有数值都在PSD的设计区间内。
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{chap/cosmic_ray/fig/atten_dist.png}
