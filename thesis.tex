...
% \ctexset{today=big}
\impthssinfo{
	cthesisname = {暗物质探测卫星塑闪阵列探测器的设计与研制}, ethesisname = {Doctor Thesis},
	ctitle = {暗物质探测卫星塑闪阵列探测器的设计与研制},
	etitle = {Design and Development of the Plastic Scintillator Detector of DArk Matter Particle Explorer},
	cauthor = {周勇},
	eauthor = {Zhou Yong},
	% eauthor = {Anonymous},
...
% \addbibresource{./refs/own-lzu.bib}
\addbibresource{./refs/own.bib}
% extra packages
...
%	\maketitle
	...
	\input{cover/ucas_copyright}
	\null\newpage
	% 原创性声明和使用授权说明。
	% \input{cover/originauth}
	\input{cover/ucas_originauth}
	\null\newpage
	% 致谢。
	...
	%
	% \include{chap/environment_test/environment_test}
	% 各章节。
...
% 	\subimport*{chap/special}{}
	...
	% 已发表论文
	\include{chap/publication/publication}
